...
export const ASSETS: Record<string, AssetConfig> = {
  ...
  gold: {
    ...
    fetchFeed: (rangeDays) => fetchGoldApi("XAUUSD", rangeDays),
  },
  apple: {
    slug: "apple",
    name: "APPLE",
  ...
  palantir: {
    ...
    symbol: "PLTR",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("PLTR", rangeDays),
  },
  broadcom: {
    slug: "broadcom",
    name: "BROADCOM",
    symbol: "AVGO",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("AVGO", rangeDays),
  },
  arista: {
    slug: "arista",
    ...
    symbol: "ANET",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("ANET", rangeDays),
  },
  fastly: {
    slug: "fastly",
    name: "FASTLY",
    symbol: "FSLY",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("FSLY", rangeDays),
  },
  uranium: {
    slug: "uranium",
    name: "URANIUM ETF",
    symbol: "URA",
    category: "Commodities",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("URA", rangeDays),
  },
  arkk: {
    slug: "arkk",
    name: "ARK ETF",
    symbol: "ARKK",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("ARKK", rangeDays),
  },
  splunk: {
    slug: "splunk",
    name: "SPLUNK",
    symbol: "SPLK",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("SPLK", rangeDays),
  },
  shopify: {
    slug: "shopify",
    name: "SHOPIFY",
    symbol: "SHOP",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("SHOP", rangeDays),
  },
  mobileye: {
    slug: "mobileye",
    name: "MOBILEYE",
    symbol: "MBLY",
    category: "Stocks",
    fetchFeed: (rangeDays) => fetchFinnhubQuote("MBLY", rangeDays),
  },
  supermicro: {
    slug: "supermicro",
